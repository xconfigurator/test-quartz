...
public class FooJob implements Job {// 注意：虽然可以这样做，但还是推荐使用Spring Boot文档中推荐的写法 extends QuartzJobBean
    ...
    protected void executeInternal(JobExecutionContext context) throws JobExecutionException {
        log.info("bar QuartzJobBean... FooJob被 {} 触发执行了！ ", context.getTrigger().getKey());
        log.info("bar QuartzJobBean... demoService = " + demoService);
        log.info("bar QuartzJobBean... demoService.hey() = {}", demoService.hey() );
    }
